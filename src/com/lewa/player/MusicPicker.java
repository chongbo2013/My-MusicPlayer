...
//            }
    ...
    public void onCreate(Bundle icicle) {
        ...
        mList = (ListView)findViewById(R.id.music_picker_list);

        mList.setItemsCanFocus(false);
        
        mAdapter = new TrackListAdapter(this, mList,
                R.layout.music_picker_item, new String[] {},
                new int[] {});

        mList.setAdapter(mAdapter);
        mList.setOnItemClickListener(MusicPicker.this);
    ...
    void setSelected(Cursor c) {
        ...
        if (newId != mPlayingId || mMediaPlayer == null) {
            stopMediaPlayer();
            //PR945833 add by qhwu to requet focus for musicpicker @ {
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        //PR945833 add by qhwu to abandon focus to return the focus to mediaplayback @ {
        if (mAudioManager != null) {
